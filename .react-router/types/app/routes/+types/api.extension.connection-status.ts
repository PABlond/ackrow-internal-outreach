...
type Module = typeof import("../api.extension.connection-status.js")

type Info = GetInfo<{
  file: "routes/api.extension.connection-status.ts",
  module: Module
}>
...
type Matches = [{
  ...
  module: typeof import("../api.extension.connection-status.js");
}];
